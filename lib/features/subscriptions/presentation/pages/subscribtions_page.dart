...
class SubscribtionsPage extends StatefulWidget {
  const SubscribtionsPage({super.key});

  @override
  State<SubscribtionsPage> createState() => _SubscribtionsPageState();
}

class _SubscribtionsPageState extends State<SubscribtionsPage> {
